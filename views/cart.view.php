          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                ...
                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                  <img src="../assets/images/products/sample-product.png" class="w-100" alt="Mechanical Keyboard" />
                  <a href="#!">
              ...
              <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                <!-- Data -->
                <p><strong>ASUS ROG FALCHION NX 65% WIRELESS MECHANICAL GAMING KEYBOA...</strong></p>
                <p>Switches: blue</p>
                <button type="button" class="btn btn-dark btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="Remove item">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                <!-- Image -->
                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                  <img src="../assets/images/products/sample-product.png" class="w-100" />
                  <a href="#!">
                    <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                  </a>
                </div>
      ...
      <div class="col-md-4">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-dark btn-md btn-block">
              Checkout
            </button>
          </div>
        </div>
